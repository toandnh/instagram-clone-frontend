        ...
        content = (
            <div className='h-full w-full bg-black flex flex-row'>
                ...
                <div className='w-1/2 grid grid-rows-[1fr_8fr_2fr_1fr] border-l border-neutral-900'>
                    <PostHeader userId={userId} username={username} userAvatar={userAvatar} postId={postId} isAuthorizedUserPost={isAuthorizedUserPost} />

                    <div className='flex flex-col gap-2 my-2 mx-2'>
                        <CommentLine userId={userId} userAvatar={userAvatar} username={user.username} text={post.caption} />
