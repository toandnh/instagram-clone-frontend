...
const SignupForm = () => {
    ...
    const handleContactChanged = (e) => {setContact(e.target.value)}
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        if (canSave)
            await addNewUser({ username, password, name, contact })
    }
    ...
    return (
        <div className='h-[560px] grid grid-rows-[2fr_1fr_7fr] border border-solid border-stone-300'>
            ...
            <div className='grid justify-items-center items-center'>
                <div className='w-72 px-0.5 font-sans font-semibold text-s text-center'>Sign up to see photos and videos from your friends.</div>
                <input type='submit' className='h-8 w-72 bg-sky-500 font-sans font-semibold text-white my-2.5 rounded cursor-pointer hover:bg-sky-600' value='Log in with Facebook' />
                <Divider />
            </div>
            ...
            <form className='grid justify-items-center items-center' onSubmit={handleSubmit}>
                ...
                <div className='w-72 px-3 font-sans text-xs text-center'>
                    ...
                    <a href='https://www.w3schools.com/' target='_blank' rel='noreferrer'> Learn More</a>
                </div>
                <div className='w-72 px-3 font-sans text-xs text-center'>
                    By signing up, you agree to our
                    <a href='https://www.w3schools.com/' target='_blank' rel='noreferrer'> Terms</a>, 
                    <a href='https://www.w3schools.com/' target='_blank' rel='noreferrer'> Privacy Policy </a> and
                    <a href='https://www.w3schools.com/' target='_blank' rel='noreferrer'> Cookies Policy</a>.
                </div>
                <input 
                    type='submit' 
